...
def setup():
    ...
    subprocess.call(['wget', 'http://www.airspayce.com/mikem/bcm2835/bcm2835-1.42.tar.gz'])
    ...
    subprocess.call(['git', 'clone', 'https://github.com/adafruit/Adafruit-Raspberry-Pi-Python-Code.git'])
